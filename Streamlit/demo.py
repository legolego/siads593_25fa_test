...
st.title('This is a test of Streamlit cloud from Deepnote through Github in OH today 9/4/2025')
...
st.markdown("Now let's make an Altair plot for another example for office hours today.")
